...
class SoundStream(nn.Module):
    ...
    def __init__(
        ...
        if self.is_semantic:
            ...
            self.semantic_model = AutoModel.from_pretrained(os.path.join(folder_paths.base_path,"custom_nodes/ComfyUI_YuE/inference/xcodec_mini_infer/semantic_ckpts/hf_1_325000")) #TO DO change dir
